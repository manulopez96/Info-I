...
int main(void) {
	...
	printf("ingrese el numero de 4 cifras que quiere codificar: ");
	scanf("%d", &num1);	
	...
	vara+=7;//suma de numero(consigna)
	varb+=7;//suma de numero(consigna)
	varc+=7;//suma de numero(consigna)
	vard+=7;//suma de numero(consigna)
	...
	printf(" \nvariables codificadas:%d%d%d%d",vara, varb, varc, vard);
